...
import {sendToTgChose} from "../../../core/Utils.ts";
...
export const SendGifModal: React.FC<ModalRatingProps> = ({isVisible, onClose, onBtnClick, itemGiftMore}) => {
            ...
            <div
                ...
                <GiftTable
                    rows={[
                        ...
                        {label: "Price", value: itemGiftMore.price.value.toString(), icon: itemGiftMore.price.imgCurrency },
